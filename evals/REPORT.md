...
| Metric | Value |
| --- | --- |
| Mean citation correctness | 0.053 |
| Mean keyphrase coverage | 0.833 |
...
| --- | --- | --- | --- |
| comparative | 5 | 0.031 | 0.933 |
| factual | 5 | 0.054 | 0.867 |
| list | 5 | 0.013 | 0.867 |
| oos | 2 | 0.250 | 0.833 |
...
| --- | --- | --- | --- | --- | --- |
| factual-001 | factual | 0.071 | 1.000 | 0 ms (mock pipeline) | — |
| factual-002 | factual | 0.133 | 1.000 | 0 ms (mock pipeline) | — |
| factual-003 | factual | 0.000 | 1.000 | 0 ms (mock pipeline) | — |
| comp-001 | comparative | 0.000 | 1.000 | 0 ms (mock pipeline) | — |
| comp-002 | comparative | 0.154 | 1.000 | 0 ms (mock pipeline) | — |
| comp-003 | comparative | 0.000 | 1.000 | 0 ms (mock pipeline) | — |
| list-001 | list | 0.067 | 0.333 | 0 ms (mock pipeline) | idempotency, retry |
...
| factual-005 | factual | 0.067 | 0.667 | 0 ms (mock pipeline) | selector |
...
| trend-001 | trend | 0.062 | 0.667 | 0 ms (mock pipeline) | task group |
| trend-002 | trend | 0.000 | 1.000 | 0 ms (mock pipeline) | — |
| oos-001 | oos | 0.167 | 0.667 | 0 ms (mock pipeline) | real-time price |
| oos-002 | oos | 0.333 | 1.000 | 0 ms (mock pipeline) | — |
